    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        >
          ...
          <li class="breadcrumb-item active" aria-current="page"><a>${mot}</a></li>
...
<div class="product-tab bg-white pt-10 pb-80">
  <div class="container">
    ...
    <div class="tab-content" id="pills-tabContent">
      ...
      >
        ...
        <c:forEach var="prod" items="${requestScope['produitstrouves']}" >
